    ...
    <Col md={16}>
      ...
      <Row>
        <Col span={22} offset={1}>
          <ul className="list-disc">
            ...
            <li>
              We've worked hard on this for the sole interest of making knowledge comfortably accessible all. So please
              if you find any inaccuracies or grievances in our work, be reasonable about it and notify us. Our data is
      ...
      <Row>
        <Col span={22} offset={1}>
          <ul className="list-disc">
            <li>
              We are not liable to any damage or harm that may come to you, anyone or your device as a result of using
              our service.
            </li>
            <li>
            ...
            <li>
              You'll use our service solely to learn, study or teach without any distortions or other agendas. You will
              use it in honesty and truth.
            </li>
            <li>
            ...
            <li>
              ...
              possible. While our content is open to all, we understand that cultural differences also play a role in
              its interpretation.
            </li>
            <li>
            ...
            <li>
              We may update our terms of service and/or privacy policy without your prior notice or consent, so you will
              check these regularly. If at any point you disagree with any of the terms, you will immediately stop using
              our service.
            </li>
          </ul>
        </Col>
